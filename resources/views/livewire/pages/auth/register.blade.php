...
<div class="min-h-screen grid lg:grid-cols-12 overflow-hidden bg-[#F8FAF8]">
        ...
        <div class="relative z-10 my-auto space-y-8 py-8">
            ...
            <div class="space-y-3">
                ...
                <p class="text-sm sm:text-base text-[#95D5B2]/90 leading-relaxed font-normal">
                    Create your account to access the Project L.E.A.F. hydroponic monitoring platform and manage your IoT-powered lettuce cultivation system.
                </p>
            </div>
                ...
                <div class="pt-1">
                    ...
                    <div class="h-8 w-full">
                        <svg class="w-full h-full" viewBox="0 0 300 40" fill="none">
                            <path d="M0,30 Q 75,10 150,22 T 300,15" fill="none" stroke="#95D5B2" stroke-width="2" stroke-linecap="round"/>
                        </svg>
                    </div>
                </div>
    ...
    <!-- ========================================== -->
    <!-- RIGHT SIDE: REGISTRATION FORM CARD (55%)   -->
    <!-- ========================================== -->
                    ...
                    <div class="space-y-1.5">
                        ...
                        <div class="relative">
                            ...
                            >
                                ...
                                <svg x-show="showConfirmPass" x-cloak class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M13.875 18.825A10.05 10.05 0 0112 19c-4.478 0-8.268-2.943-9.543-7a9.97 9.97 0 011.563-3.029m5.858-5.908a10.017 10.017 0 014.288-.936c4.478 0 8.268 2.943 9.543 7a10.025 10.025 0 01-4.132 5.411m0 0L21 21M3 3l18 18"/>
                                </svg>
                            </button>
                        </div>
